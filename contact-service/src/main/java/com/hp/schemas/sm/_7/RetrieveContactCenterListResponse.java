 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="instance" type="{http://schemas.hp.com/SM/7}ContactCenterInstanceType" maxOccurs="unbounded"/&amp;gt;
...
@XmlRootElement(name = "RetrieveContactCenterListResponse")
public class RetrieveContactCenterListResponse {

    @XmlElement(required = true)
    protected List<ContactCenterInstanceType> instance;
     ...
     * 
     */
    public List<ContactCenterInstanceType> getInstance() {
        if (instance == null) {
            instance = new ArrayList<ContactCenterInstanceType>();
        }
