...
public class PollsBO {
	...
	public String toString() {
		...
		builder.append("PollsBO [action=").append(action).append(", pollId=").append(pollId).append(", lang=")
				.append(lang).append(", userId=").append(userId).append(", userAgent=").append(userAgent)
				.append(", ipAddress=").append(ipAddress).append(", NLUID=").append(nlUId).append(", startDate=")
				.append(startDate).append(", endDate=").append(endDate).append(", persona=").append(persona)
				.append(", votedOn=").append(votedOn).append(", votedFrom=").append(votedFrom).append(", question=")
				.append(question).append(", selectedOption=").append(selectedOption).append(", currentPollsPerPage=")
				.append(currentPollsPerPage).append(", pastPollsPerPage=").append(pastPollsPerPage).append(", group=")
				.append(group).append(", groupCategory=").append(groupCategory).append(", category=").append(category)
				.append(", solrCategory=").append(solrCategory).append(", serviceEntities=").append(serviceEntities)
				.append(", topics=").append(topics).append(", pollGroupConfig=").append(pollGroupConfig)
				.append(", pollGroupConfigCategory=").append(pollGroupConfigCategory).append(", captchaResponse=")
				.append(captchaResponse).append("]");
