...
public class CommonUtils {
	...
	/**
	 * This method will get dcr path as param and check if it exists, read it and
	...
	/**
	 * This method will get dcr path as param and check if it exists.
	 * 
	 * @param path DCR path.
	 *
	...
	/**
	 * This method will get dcr path as param, append it with file root to return
	...
	/**
	 * This method will get various component context param values to fetch the dcr
	 * content and return as documument.
	 * 
	...
	/**
	 * This method will take dct value and concatenate them with dcr category to
	 * return the dcr category path.
	 * 
	 * @param dct DCT value..
	 *
	 * @return categoryPath return the dct and locale concatenated category path.
	 */
	...
	/**
	 * This method will take dct,dcr name and locale to concatenate them and return
	 * the dcr category path.
	 * 
	 * @param dct         DCT value..
	 ...
	 * @return categoryPath return the dct and locale concatenated category path.
	 */
	public String getCategoryPath(final String dct, final String localeValue, final String dcr) {
	...
	/**
	 * This method will take dct name and locale, concatenate them to return the dcr
	 * category path.
	 * 
	 * @param dct         DCT value..
	 * @param localeValue Locale value.
	 ...
	 * @return categoryPath return the dct and locale concatenated category path.
	 */
	public String getCategoryPath(final String dct, final String localeValue) {
	 ...
	 *
	 * @return String value of the XML Node if it is available in Document. Blank
	 *         String otherwise.
	 */
	 ...
	 * 
	 * @param locale String representing the locale for which URL to be generated
	 * while pretty print.
	 * 
	...
	/*
	 * Get URL Prefix based on the Request Header forwarded host. This helps create
	 * the URL with FQDN values.
	 *
	...
	/*
	 * Generate Image SEO Metadata. For Example, og:image, twitter:image, etc.
	 *
	 * @param RequestContext context
	 * 
	...
	public void generateImageMetadata(RequestContext context, String imageValue, String urlPrefix) {
		...
		Map<String, Integer> imageDimensions = getImageDimensions(
				context.getFileDal().getRoot() + context.getFileDal().getSeparator() + imageValue);
	...
	/*
	 * Sanitize Values to be used for HTML metadata. This prevents breaking HTML
	 * meta tags for special characters. Uses LiveSite StringUtil methods.
	 *
	...
	/*
	 * Remove the HTML Tags present in content. This is used to remove HTML meta
	 * tags from content to use the content at the special places like SEO Metadata.
	...
	public void generateSEOMetaTagsForDynamicContent(Document dcr, RequestContext context) {
		...
		if (StringUtils.isBlank(description)) {
			description = sanitizeMetadataField(
					removeHTMLTags(getValueFromXML("/content/root/detail/description", dcr)));
		...
		if (imageValue.equals("")) {
			imageValue = paramLocale.equals("ar") ? SEOController.DEFAULT_SOCIAL_IMAGE_AR
					: SEOController.DEFAULT_SOCIAL_IMAGE_EN;
		}
	...
	/*
	 * Throw DCR Not Found Exception. Redirect user to the custom error page with
	 * 404 status code.
	 *
	 * @param RequestContext context
	 * 
	...
	public void logBrokenLink(RequestContext context, String brokenLink, String contentPage, String language,
			String statusCode) {
	...
	public int getErrorCount(RequestContext context, String brokenLink, String contentPage, String language,
			String statusCode) {
	...
	public int updateErrorCount(RequestContext context, int count, String brokenLink, String contentPage,
			String language, String statusCode) {
	...
	public int esapiValidator(String name, String str, String type, int length, boolean allowNull,
	...
	public int inserErrorResponse(RequestContext context, int count, String brokenLink, String contentPage,
			String language, String statusCode) {
		...
		if (errorCount > 0) {
			...
			logger.info("Logging the Broken link with status: " + statusCode + ", for URL: " + brokenLink
					+ ", present on: " + contentPage + " for language: " + language);
			PreparedStatement statement = null;
			Connection connection = null;
			Postgre database = new Postgre(context);
			try {
