...
public class WeatherApi {
	...
	public Document getWeather(final RequestContext context) {
		...
		weatherUrl = urlPrefix + weatherUrl;
		currentTempURL = urlPrefix + currentTempURL;
	...
	private JSONObject returnTempData(JSONArray jsonArrayWeather, String todayEn, String todayAr, String tempMin,
			String tempMax, String currentCity) {
