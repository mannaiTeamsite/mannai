...
public class SolrQueryBuilder {
		...
		try {
			if (queryType.equals(BASE_QUERY)) {
				if (!isheader) {
					...
					query = commonUtils.sanitizeSolrQuery(
			...
			logger.error("Unable to decode Query=" + context.getParameterString(queryType), e);
		}
	...
	public StringBuilder sbBuilder(StringBuilder sb) {
